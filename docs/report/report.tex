...
% can;t come up with a third one our data can prove
...
We selected FaaS services from the 5 largest public clouds. % todo: find source
...
a real world % todo: find source
usecase and an often used example in what FaaS solutions are good for. % todo: find sourcem AWS?
...
% todo: figure 1: performance over time
...
Our results in Figure 3 % number?
...
What is unexpected is in Figure 2, % number ?
