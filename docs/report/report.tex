...
%put more focus on the autoscaling (and cold starts, they are important for autoscaling)! cold starts are a major factor in concurrency, u want to scale out
...
% Include in table: instance size (memory), python runtime, web framework, location of dc + provider specific things (aws we use their api gateway)
