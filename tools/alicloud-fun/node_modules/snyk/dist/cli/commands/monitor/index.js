    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options['experimental-dep-graph']) {
            ...
            if (isFFSupported.code === 401) {
                throw errors_1.AuthFailedError(isFFSupported.error, isFFSupported.code);
            }
            if (!isFFSupported.ok) {
            ...
            try {
                ...
                for (const projectDeps of perProjectResult) {
                    ...
                    const projectName = cli_interface_1.legacyPlugin.isMultiResult(inspectResult)
                        ...
                        : undefined;
                    const monOutput = format_monitor_response_1.formatMonitorOutput(packageManager, res, manageUrl, options, projectName, foundProjectCount);
...
function convertMultiPluginResultToSingle(result) {
